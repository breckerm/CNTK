...
// In this case CNTK_HEADERONLY_DEFINITIONS should be defined when CNTKLibrary.h is included.
...
namespace CNTK {
    ...
    namespace Internal
    {
        ...
        {
            LogicError("Should not be called, used only for external symbol resolution.");
        }
    }
}
